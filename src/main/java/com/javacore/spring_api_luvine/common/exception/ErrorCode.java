...
public enum ErrorCode {
    ...
    VARIANT_ALREADY_ACTIVATE(HttpStatus.BAD_REQUEST),
    VARIANT_ALREADY_DEACTIVATE(HttpStatus.BAD_REQUEST),
    CATEGORY_ALREADY_ACTIVATE(HttpStatus.BAD_REQUEST),
    CATEGORY_ALREADY_DEACTIVATE(HttpStatus.BAD_REQUEST),
